...
!function () {
    ...
    -1 < navigator.platform.indexOf("Win") && (
        document.getElementsByClassName("main-content")[0] && (e = document.querySelector(".main-content")),
...
function sidebarType(e) {
    for (var t = e.parentElement.children, a = e.getAttribute("data-class"), n = document.querySelector("body:not(.dark-version)"), i = body.classList.contains("dark-version"), l = [], s = 0; s < t.length; s++)
        t[s].classList.remove("active"),
            l.push(t[s].getAttribute("data-class"));
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active");
    for (var r, o, c, d = document.querySelector(".sidenav"), s = 0; s < l.length; s++)
        d.classList.remove(l[s]);
    if (d.classList.add(a),
        "bg-white" == a) {
        ...
        for (let e = 0; e < g.length; e++)
            g[e].classList.add("text-white"),
                g[e].classList.remove("text-dark")
    }
    if ("bg-default" == a && i) {
...
function navbarFixed(e) {
    ...
    e.getAttribute("checked") ? (toggleNavLinksColor("transparent"),
        a.classList.remove(...t),
        a.setAttribute("data-scroll", "false"),
        navbarBlurOnScroll("navbarBlur"),
        e.removeAttribute("checked")) : (toggleNavLinksColor("blur"),
            a.classList.add(...t),
            ...
            window.innerWidth < 991 && total.forEach(function (n, e) {
                if (!n.classList.contains("flex-column")) {
                    ...
                    for (var i = 1; i <= t.indexOf(e); i++)
                        a += n.querySelector("li:nth-child(" + i + ")").offsetHeight;
                    var l = document.querySelector(".moving-tab");
                    l.style.width = n.querySelector("li:nth-child(1)").offsetWidth + "px",
                        l.style.transform = "translate3d(0px," + a + "px, 0px)"
                }
            })
    })
}
...
setTimeout(function () {
    ...
    window.addEventListener("resize", function (e) {
        total.forEach(function (a, e) {
            a.querySelector(".moving-tab").remove();
            var n = document.createElement("div")
                , i = a.querySelector(".nav-link.active").cloneNode();
            i.innerHTML = "-",
            ...
            let l = a.querySelector(".nav-link.active").parentElement;
            if (l) {
                let e = Array.from(l.closest("ul").children);
                i = e.indexOf(l) + 1;
                let t = 0;
                if (a.classList.contains("flex-column")) {
                    for (var s = 1; s <= e.indexOf(l); s++)
                        t += a.querySelector("li:nth-child(" + s + ")").offsetHeight;
                    n.style.transform = "translate3d(0px," + t + "px, 0px)",
                        n.style.width = a.querySelector("li:nth-child(" + i + ")").offsetWidth + "px",
                        n.style.height = a.querySelector("li:nth-child(" + s + ")").offsetHeight
                } else {
                    for (s = 1; s <= e.indexOf(l); s++)
                        t += a.querySelector("li:nth-child(" + s + ")").offsetWidth;
            ...
            window.innerWidth < 991 ? total.forEach(function (n, e) {
                ...
                if (n.classList.contains("on-resize")) {
                    ...
                    for (var l = 1; l <= t.indexOf(e); l++)
                        a += n.querySelector("li:nth-child(" + l + ")").offsetWidth;
                    var s = document.querySelector(".moving-tab");
                    s.style.transform = "translate3d(" + a + "px, 0px, 0px)",
                        s.style.width = n.querySelector("li:nth-child(" + i + ")").offsetWidth + "px"
                }
            })
    }),
...
function toggleSidenav() {
    const currentBgColor = getComputedStyle(sidenav).backgroundColor;

    if (body.classList.contains(className)) {
        // If the body has the class, remove it
        body.classList.remove(className);
        setTimeout(function () {
            // Only remove bg-white if it's currently applied
            if (currentBgColor === 'rgb(255, 255, 255)') { // #fff is white
                sidenav.classList.remove("bg-white");
            } else if (currentBgColor === 'rgb(23, 193, 232))') { // rgb(23, 162, 184) is the default bg-info color
                sidenav.classList.remove("bg-info");
            }
        }, 100);
        ...
        // Only add bg-white if it's not currently white or info
        if (currentBgColor !== 'rgb(255, 255, 255)' && currentBgColor !== 'rgb(23, 193, 232)') {
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        t.classList.remove("dark-version"),
            ...
            L.includes("logo-ct.png") && (B = L.replace("logo-ct", "logo-ct-dark"),
                w.src = B);
        for (E = 0; E < S.length; E++)
            S[E].classList.contains("text-dark") && (S[E].classList.add("text-white"),
                S[E].classList.remove("text-dark"));
        for (E = 0; E < k.length; E++)
            k[E].classList.contains("text-white") && (k[E].classList.remove("text-white"),
                k[E].classList.add("text-dark"));
        for (E = 0; E < q.length; E++)
            q[E].classList.contains("text-white") && q[E].classList.remove("text-white");
        for (E = 0; E < C.length; E++)
            C[E].classList.add("blur", "shadow-blur");
        for (E = 0; E < A.length; E++)
            A[E].classList.add("blur");
        for (E = 0; E < a.length; E++)
            a[E].classList.contains("light") && (a[E].classList.add("dark"),
                a[E].classList.remove("light"));
        for (E = 0; E < l.length; E++)
            l[E].classList.contains("light") && (l[E].classList.add("dark"),
                l[E].classList.remove("light"));
        for (E = 0; E < s.length; E++)
            s[E].classList.contains("text-white") && (s[E].classList.remove("text-white"),
                s[E].classList.add("text-dark"));
        for (E = 0; E < o.length; E++)
            !o[E].classList.contains("text-white") || o[E].closest(".sidenav") || o[E].closest(".card.bg-gradient-dark") || (o[E].classList.remove("text-white"),
                o[E].classList.add("text-dark"));
        for (E = 0; E < d.length; E++)
            d[E].classList.contains("text-white") && (d[E].classList.remove("text-white"),
                d[E].classList.add("text-dark"));
        for (E = 0; E < m.length; E++)
            m[E].classList.contains("text-white") && (m[E].classList.remove("text-white"),
                m[E].classList.remove("opacity-8"),
                m[E].classList.add("text-secondary"));
        for (E = 0; E < f.length; E++)
            f[E].classList.contains("bg-gray-600") && (f[E].classList.remove("bg-gray-600"),
                f[E].classList.add("bg-gray-100"));
        for (E = 0; E < x.length; E++)
            x[E].hasAttribute("fill") && x[E].setAttribute("fill", "#6c757d");
        for (E = 0; E < b.length; E++)
            b[E].closest(".card.bg-gradient-dark") || (b[E].classList.remove("text-white"),
                b[E].classList.add("text-dark"));
        for (E = 0; E < p.length; E++)
            p[E].classList.remove("border-dark");
        e.removeAttribute("checked")
    } else {
        var B;
        t.classList.add("dark-version"),
            L.includes("logo-ct-dark.png") && (B = L.replace("logo-ct-dark", "logo-ct"),
                w.src = B);
        for (var E = 0; E < C.length; E++)
            C[E].classList.contains("blur") && C[E].classList.remove("blur", "shadow-blur");
        for (var E = 0; E < S.length; E++)
            S[E].classList.contains("text-white") && S[E].classList.remove("text-white");
        for (var E = 0; E < A.length; E++)
            A[E].classList.contains("blur") && A[E].classList.remove("blur");
        for (var E = 0; E < k.length; E++)
            k[E].classList.contains("text-dark") && (k[E].classList.remove("text-dark"),
                k[E].classList.add("text-white"));
        for (var E = 0; E < q.length; E++)
            q[E].classList.contains("text-sm") && q[E].classList.add("text-white");
        for (var E = 0; E < a.length; E++)
            a[E].classList.contains("dark") && (a[E].classList.remove("dark"),
                a[E].classList.add("light"));
        for (var E = 0; E < l.length; E++)
            l[E].classList.contains("dark") && (l[E].classList.remove("dark"),
                l[E].classList.add("light"));
        for (var E = 0; E < s.length; E++)
            s[E].classList.contains("text-dark") && (s[E].classList.remove("text-dark"),
                s[E].classList.add("text-white"));
        for (var E = 0; E < r.length; E++)
            r[E].classList.contains("text-dark") && (r[E].classList.remove("text-dark"),
                r[E].classList.add("text-white"));
        for (var E = 0; E < c.length; E++)
            c[E].classList.contains("text-dark") && (c[E].classList.remove("text-dark"),
                c[E].classList.add("text-white"));
        for (var E = 0; E < u.length; E++)
            u[E].classList.contains("text-dark") && (u[E].classList.remove("text-dark"),
                u[E].classList.add("text-white"));
        for (var E = 0; E < g.length; E++)
            g[E].classList.contains("text-secondary") && (g[E].classList.remove("text-secondary"),
                g[E].classList.add("text-white"),
                g[E].classList.add("opacity-8"));
        for (var E = 0; E < v.length; E++)
            v[E].classList.contains("bg-gray-100") && (v[E].classList.remove("bg-gray-100"),
                v[E].classList.add("bg-gray-600"));
        for (var E = 0; E < h.length; E++)
            h[E].classList.remove("text-dark"),
                h[E].classList.add("text-white");
        for (var E = 0; E < i.length; E++)
            i[E].classList.remove("bg-white");
        for (var E = 0; E < x.length; E++)
            x[E].hasAttribute("fill") && x[E].setAttribute("fill", "#fff");
        for (E = 0; E < y.length; E++)
            y[E].classList.add("border-dark");
        e.setAttribute("checked", "true")
    }
}
